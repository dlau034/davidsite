...
<?php get_header(); ?>
    ...
    <div class="row">
      ...
      <div class="col-xs-3 portfolio-piece">
          ...
          <!-- Get the thumbnail from featured image -->
          <!-- Creates the thumbnail id and url -->
          ...
          <!-- Print out thumbnail into IMG -->

          <p><a href="<?php the_permalink();?>"><img src=" <?php echo $thumbnail_url[0] ?> " alt="<?php the_title(); ?>"></a></p>

          <!-- Print out title tag of each portfolio post -->

          <h4><a href="<?php the_permalink();?>"><?php the_title(); ?></a></h4>

      </div>

      <!-- For every four portfolio post, inset in div class of row -->
